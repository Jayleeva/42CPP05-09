...
# define MIN_FLOAT std::numeric_limits<float>::min() // -13961276984
# define MAX_FLOAT std::numeric_limits<float>::max() // 13961276983
# define MIN_DOUBLE std::numeric_limits<double>::min() // -101324546824
# define MAX_DOUBLE std::numeric_limits<double>::max() // 101324546823
